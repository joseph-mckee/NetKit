...
public class NetworkInformation
{
    ...
    private NetworkInformation(uint ipAddress, uint subnetMask)
    {
    ...
    public NetworkInformation(IPAddress ipAddress, IPAddress subnetMask) : this(IpMath.IpToBits(ipAddress),
        IpMath.IpToBits(subnetMask))
    {
    }

    public NetworkInformation(string ipAddress, string subnetMask) : this(IPAddress.Parse(ipAddress),
